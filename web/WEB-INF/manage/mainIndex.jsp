...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo"><a href="mainIndex.jsp"><img src="images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a target="right" href="${pageContext.request.contextPath }/manage/qureyAllUser" class="now">查看所有</a></li>
                    <li><a href="">新增</a></li>
                </ul>
            </div>
            <div class="left_m">
                ...
                <ul>
                	<li><a target="right" href="adminQueryList" class="now">查看所有</a></li>
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a target="right" href="Member_Order.html" class="now">查看所有</a></li>
                    <li><a href="Member_Address.html">新增</a></li>
                </ul>
            </div>
        </div>
